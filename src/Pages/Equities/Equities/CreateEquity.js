                 ...
                 <MuiPickersUtilsProvider utils={DateFnsUtils}>
                        <div>
                            <div className={classes.tabHeading}>
                              ...
                              <div className={classes.textField}><TextField name="LotSize" helperText="Only Numbers are allowed" inputProps={{ min: "0"}}  type='number' label="Lot Size" variant="outlined" value={this.state.LotSize} fullWidth onChange={(e)=>this.setState({LotSize:e.target.value})} /></div>
                            ...
                            <div className={classes.tabSubHeading}><Typography variant="h6" gutterBottom component="div" className={classes.tab}>Security Details</Typography></div>
                              <Divider/>
                              <div className={classes.textField}><TextField  label="Is ADR" variant="outlined" fullWidth name="IsADR" value={this.state.IsADR} onChange={(e)=>this.setState({IsADR:e.target.value})} /></div>
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <div className={classes.textField}><TextField name="PERatio" label="PE Ratio" variant="outlined" helperText="Only Numbers are allowed" inputProps={{ min: "0"}}  type='number' fullWidth value={this.state.PERatio} onChange={(e)=>this.setState({PERatio:e.target.value})}/></div>
                            </div>
                            ...
                            <div className={classes.tabHeading}>
                             <div className={classes.tabSubHeading}><Typography variant="h6" gutterBottom component="div" className={classes.tab}>Divident History</Typography></div>
                              ...
                              <div className={classes.textField}><TextField name="DividentAmount" inputProps={{ min: "0"}} type='number' helperText="Only Numbers are allowed" label="Amount" variant="outlined" fullWidth value={this.state.DividentAmount} onChange={(e)=>this.setState({DividentAmount:e.target.value})}/></div>
