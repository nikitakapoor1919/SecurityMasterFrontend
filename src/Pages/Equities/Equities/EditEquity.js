      ...
      <Container>
        ...
        <Snackbar open={this.state.openError} autoHideDuration={6000} onClose={this.handleCloseError}>
          <Alert onClose={this.handleCloseError} severity="error" sx={{ width: '100%' }}>
             This field can't be less than 0
          </Alert>
        </Snackbar>
      </Container>
    )
