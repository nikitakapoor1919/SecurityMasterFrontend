                 ...
                 <MuiPickersUtilsProvider utils={DateFnsUtils}>
                        <div>
                            <div className={classes.tabHeading}>
                              ...
                              <Divider/>
                              <div className={classes.textField}><TextField name="SecurityName" label="Security Name" variant="outlined" fullWidth placeholder required error={this.state.requiredError} helper={this.state.requiredError ? "Field can't be empty":""}/></div>
                              <div className={classes.textField}><TextField name="SecurityDescription" label="Security Description" variant="outlined"  fullWidth onChange={(e)=>this.setState({SecurityDescription:e.target.value})} required error={this.state.requiredError} helper={this.state.requiredError ? "Field can't be empty":""}/></div>
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <div className={classes.textField}><TextField name="CouponRate"error={this.state.CouponRate < 0} helperText={this.state.CouponRate < 0?"Only Numbers are allowed and can't be less than zero" : ""} type='number' label="Coupon Rate" variant="outlined" fullWidth  onChange={(e)=>this.setState({CouponRate:e.target.value})}/></div>
                              ...
                              <div className={classes.textField}>
                              {/* <TextField name="FixToFloatFlag" label="Fix To Float Flag" variant="outlined" fullWidth  onChange={(e)=>this.setState({FixToFloatFlag:e.target.value})}/> */}
                              ...
                              <div className={classes.textField}>
                              {/* <TextField name="HasPosition" label="Has Position" variant="outlined" fullWidth onChange={(e)=>this.setState({HasPosition:e.target.value})}/> */}
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <Divider/>
                              <div className={classes.textField}><TextField name="MaculayDuration" error={this.state.MaculayDuration < 0} helperText={this.state.MaculayDuration < 0?"Only Numbers are allowed and can't be less than zero" : ""}  type='number' label="Maculay Duration" variant="outlined" fullWidth onChange={(e)=>this.setState({MaculayDuration:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="Volatility30D" error={this.state.Volatility30D < 0} helperText={this.state.Volatility30D < 0?"Only Numbers are allowed and can't be less than zero" : ""}  type='number' label="Volatility30D" variant="outlined" fullWidth onChange={(e)=>this.setState({Volatility30D:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="Volatility90D" error={this.state.Volatility90D < 0} helperText={this.state.Volatility90D < 0?"Only Numbers are allowed and can't be less than zero" : ""}  type='number' label="Volatility90D" variant="outlined" fullWidth onChange={(e)=>this.setState({Holatility90D:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="Convexity" error={this.state.Convexity < 0} helperText={this.state.Convexity < 0?"Only Numbers are allowed and can't be less than zero" : ""}  type='number' label="Convexity" variant="outlined" fullWidth onChange={(e)=>this.setState({Convexity:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="AverageVolume30D"error={this.state.AverageVolume30D < 0} helperText={this.state.AverageVolume30D< 0?"Only Numbers are allowed and can't be less than zero" : ""}  type='number' label="Average Volume 30D" variant="outlined" fullWidth onChange={(e)=>this.setState({AverageVolume30D:e.target.value})}/></div>
                            </div>
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <div className={classes.textField}><TextField name="CountryOfIssurance" label="Country Of Issurance" variant="outlined" fullWidth onChange={(e)=>this.setState({CountryOfIssurance:e.target.value})} required error={this.state.requiredError} helper={this.state.requiredError ? "Field can't be empty":""}/></div>
                              <div className={classes.textField}><TextField name="IssueCurrency" label="Issue Currency" variant="outlined" fullWidth  onChange={(e)=>this.setState({IssueCurrency:e.target.value})} required error={this.state.requiredError} helper={this.state.requiredError ? "Field can't be empty":""}/></div>
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <div className={classes.textField}><TextField name="PutPrice"  type='number' error={this.state.PutPrice < 0} helperText={this.state.PutPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""} label="Put Price" variant="outlined" fullWidth  onChange={(e)=>this.setState({PutPrice:e.target.value})}/></div>
                            </div>
                            ...
                            <div className={classes.tabHeading}>
                              ...
                              <Divider/>
                              <div className={classes.textField}><TextField name="AskPrice" error={this.state.AskPrice < 0} helperText={this.state.AskPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""} type='number' label="Ask Price" variant="outlined" fullWidth onChange={(e)=>this.setState({AskPrice:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="HighPrice" error={this.state.HighPrice < 0} helperText={this.state.HighPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""}   type='number' label="High Price" variant="outlined" fullWidth onChange={(e)=>this.setState({HighPrice:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="Volume"  type='number'error={this.state.Volume < 0} helperText={this.state.Volume < 0?"Only Numbers are allowed and can't be less than zero" : ""}  label="Volume" variant="outlined" fullWidth  onChange={(e)=>this.setState({Volume:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="LowPrice" type='number' error={this.state.LowPrice < 0} helperText={this.state.LowPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""}   label="Low Price" variant="outlined" fullWidth  onChange={(e)=>this.setState({LowPrice:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="BidPrice" type='number' error={this.state.BidPrice < 0} helperText={this.state.BidPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""}  label="Bid Price" variant="outlined" fullWidth onChange={(e)=>this.setState({BidPrice:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="LastPrice" type='number' error={this.state.LastPrice < 0} helperText={this.state.LastPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""}  label="Last Price" variant="outlined" fullWidth  onChange={(e)=>this.setState({LastPrice:e.target.value})}/></div>
                              <div className={classes.textField}><TextField name="OpenPrice" type='number' error={this.state.OpenPrice < 0} helperText={this.state.OpenPrice < 0?"Only Numbers are allowed and can't be less than zero" : ""}  label="Open Price" variant="outlined" fullWidth onChange={(e)=>this.setState({OpenPrice:e.target.value})}/></div>
                            </div>
